#ifndef GLTF_FILE_PARSE_H
#define GLTF_FILE_PARSE_H
...
struct MeshPrimitive
{
	...
	{
		const vector<pair<string, int>>::const_iterator& found = find_if(attributes.begin(), attributes.end(), [&key](const pair<string, int>& item){return item.first == key;});
